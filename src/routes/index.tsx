...
const goalieImg = "https://images.unsplash.com/photo-1431324155629-1a6deb1dec8d?auto=format&fit=crop&q=80&w=1200";
        ...
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
          {[
            ...
            >
              ...
              <img
                src={typeof c.img === 'string' ? c.img : c.img.url}
                alt={c.title}
                width={1200}
                height={900}
                loading="lazy"
        ...
        <div className="grid grid-cols-2 gap-4 md:grid-cols-4">
          {[
            ...
            <img
              key={i}
              data-reveal
              src={typeof it.src === 'string' ? it.src : it.src.url}
              alt={it.alt}
              width={1200}
              height={900}
              loading="lazy"
            ...
            {[
              ...
              >
                ...
                <figcaption className="mt-4 flex items-center gap-3">
                  <img
                    src={typeof t.img === 'string' ? t.img : t.img.url}
                    alt={t.n}
                    width={44}
                    height={44}
                    loading="lazy"
